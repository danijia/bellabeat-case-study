...
df = pd.read_csv('/data/fitabase_data_3.12.16_to_4.11.16/dailyActivity_merged_1.csv', encoding="latin1")
...
df_2 = pd.read_csv('/data/fitabase_data_4.12.16_to_5.12.16/dailyActivity_merged_2.csv')
